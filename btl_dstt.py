...
# Load the dataset
df = pd.read_csv("D:\Study\Linear Algebra\Materials\dataset1.csv")
...
new_data_point = np.array([[2.67, 1.55]])
new_data_point_lda = new_data_point.dot(W)
